                                                ...
                                                <tr>
                                                    <td valign="top" style="padding-bottom: 0px;">
                                                        ...
                                                        <div  style="color:#636363;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 30px">
                                                            <h4 style="font-weight: 600; font-size: 18px; color: #000000;">Dear {{$user->first_name." ".$user->last_name}},</h4>
                                                            <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000000; text-align: left;">
                                                                Your account has been verified and now you can login to your {{ config('app.name') }} account using your registered email id and password .</p>

                                                               <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000000; text-align: left;">
                                                                    <a style="text-decoration: none;color: #2C93FA;" href="{{$link}}" target="_blank" rel="noopener noreferrer">Click Here</a> to Login
                                                                </p>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td colspan="2" valign="middle"
                                                                    ...
                                                                    <p style="color: #000; margin-top: 0px; margin-bottom: 20px;">
                                                                            <a href="{{ route('seller-policy') }}" style="font-size: 14px; text-decoration: none; margin-right: 15px;    color: #ff7900;">Seller Policy</a>
                                                                            <a href="{{ route('handwi-payment-policy') }}" style="font-size: 14px; text-decoration: none;    color: #ff7900;">Handwi Payment Policy</a>
                                                                        </p>
