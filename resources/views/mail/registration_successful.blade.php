                                        ...
                                        <table style="background:#eee; font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;width: 100%;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <h1 style="color: #000; font-size: 25px; line-height: 26px; margin:30px 0 0 0;">Registration Completed Successfully!!</h1>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" style="padding-bottom: 0px;">
                                                                            <div style="color:#000;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 30px">
                                                                                ...
                                                                                <br style="margin:0;padding:0">
                                                                                <p style="margin:0;padding:0;margin-bottom:5px;color:#000;font-weight:400;font-size:13px;line-height:1.6">You are successfully registered with {{ env("APP_NAME") }}. 
</p>
