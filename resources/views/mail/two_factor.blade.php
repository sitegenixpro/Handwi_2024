...
<title>Two Factor Authentications</title>     
</head>
                                            ...
                                            <table border="0" cellpadding="20" cellspacing="0" width="100%" style="font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;">
                                                ...
                                                <tr>
                                                    <td valign="top" style="padding-bottom: 0px;">
                                                        <div align="center"><strong><h2 style="color: #000; font-size: 20px;line-height: 100%;">Verify Your {{ env('APP_NAME') }} Authentication</h2></strong></div>
                                                        <div  style="color:#000;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 30px">
                                                            ...
                                                            <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000; text-align: left;">
                                                                We've received a request to login for your {{ env('APP_NAME') }} account.
                                                           Your Authentication code is given below.</p>
