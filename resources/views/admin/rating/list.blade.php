            ...
            <?php $i++; ?>
               <tr>
                   ...
                   <td>{{rating_type($item->type)}}
                    <br><strong>{{$item->name_product}}</strong></td>
                   <td>{{$item->name}}</td>
                   <td>{{$item->rating}}</td>
                   <!--<td>{{$item->title}}</td>-->
                   <td>{{$item->comment}}</td>
                   <td class="text-center">
                            <div class="dropdown custom-dropdown">
                                ...
                                @else
                                <a class="dropdown-item" href="{{url('admin/rating/view_reply/'.$item->id)}}"><i class="flaticon-pencil-1"></i> view reply</a>
                                @endif
                                    <a class="dropdown-item" data-role="unlink" data-message="Do you want to remove this details?" href="{{url('admin/rating/delete/'.$item->id)}}"><i class="flaticon-delete-1"></i> Delete</a>
