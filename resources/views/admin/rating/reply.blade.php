                   ...
                   <td class="text-center">
                            <div class="dropdown custom-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                    ...
                                    <a class="dropdown-item" data-role="unlink" data-message="Do you want to remove this details?" href="{{url('admin/rating/delete_reply/'.$item->id)}}"><i class="flaticon-delete-1"></i> Delete</a>
