...
.ck-editor__editable {
    ...
    <div class="card mb-5">
        <div class="card-body">
            <form method="POST" action="{{ url('admin/vendors/store') }}" id="admin-form" enctype="multipart/form-data" data-parsley-validate="true">
                @csrf
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="shop_name_ar">Shop Name (Arabic)</label>
                                    <input 
                                        type="text" 
                                        name="shop_name_ar" 
                                        class="form-control" 
                                        dir="rtl"
                                        placeholder="اكتب اسم المتجر بالعربية"
                                        value="{{ isset($storeDetails) ? $storeDetails->store_name_ar : old('shop_name_ar') }}"
                                    >
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                   ...
                                   <input 
                                        ...
                                        class="form-control jqv-input" 
                                        accept="image/*"
                                        onchange="previewImage(event, 'logo_preview', 'editlogosrc')"
                                    />
                                    @if(isset($storeDetails->logo) && !empty($storeDetails->logo))
                                        <div id="editlogosrc">
                                            <label>Current Logo:</label>
                                            <!-- Show existing logo -->
                                            <img src="{{  $storeDetails->logo }}" id="logo_current_preview" style="max-width: 200px; max-height: 200px; display: block;">
                                        </div>
                                    @endif
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea 
                                    name="shop_desc" 
                                    class="form-control jqv-input ckeditor" 
                                    required
                            ...
                            <div class="col-md-12 form-group">
                                <label for="shop_desc_ar">Shop Description (Arabic)</label>
                                <textarea 
                                    name="shop_desc_ar" 
                                    class="form-control ckeditor rtl-text" 
                                    rows="3"
                                    dir="rtl"
                                    placeholder="اكتب وصف المتجر بالعربية"
                                >{{ isset($storeDetails) ? $storeDetails->description_ar : old('shop_desc_ar') }}</textarea>
                            </div>
                             <div class="col-md-12 form-group d-none">
                                <label for="about_us">About Your Shop <b class="text-danger">*</b></label>
                                <textarea 
                                    name="about_us" 
                                    id="about_us" 
                                    class="form-control jqv-input ckeditor" 
                                    required
                                    data-parsley-required-message="About your shop is required"
                                    placeholder="About your shop"
                                    rows="10"
                                >Abouts US</textarea>
                            </div>
                            <div class="col-md-12 form-group d-none">
                                <label for="about_us">About Your Shop (Arabic)<b class="text-danger">*</b></label>
                                <textarea 
                                    name="about_us_ar" 
                                    id="about_us_ar" 
                                    dir="rtl"
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-header bg-light">
                            ...
                            <p>View the delivery time setup for this store.</p>
                        </div>
                        <div class="card-body">
                            @if(isset($storeDetails->delivery_type) && !empty($storeDetails->delivery_type))
                                <div class="form-group d-none">
                                    <label for="delivery_type">Delivery Type</label>
                                    <input type="text" class="form-control" value="{{ ucfirst($storeDetails->delivery_type) }}" readonly>
                                </div>

                              
                                    <div class="form-group">
                                        <label for="standard_delivery_text">Standard Delivery Text</label>
                                        <input type="text" class="form-control" value="{{ $storeDetails->standard_delivery_text }}" readonly>
                                    </div>
                                
                                    @if(!empty($storeDetails->delivery_min_days))
                                        <div class="form-group">
                                            <label for="delivery_min_days">Custom Delivery Minimum Days</label>
                                            <input type="text" class="form-control" value="{{ $storeDetails->delivery_min_days }}" readonly>
                                        </div>
                                    @endif

                                    @if(!empty($storeDetails->delivery_max_days))
                                        <div class="form-group">
                                            <label for="delivery_max_days">Custom Delivery Maximum Days</label>
                                            <input type="text" class="form-control" value="{{ $storeDetails->delivery_max_days }}" readonly>
                                        </div>
                                    @endif
                                
                            @else
                                <p class="text-muted">Delivery information not set.</p>
                            @endif
                        </div>
                    </div>
                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input 
                                        ...
                                        value="disabled" 
                                        <?php 
                                            if (isset($vendor) && !empty($vendor) && $vendor->two_factor_auth !== 'enabled') {
                                                echo 'checked';
                                            } 
                                        ?>
                                    >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input 
                                        ...
                                        max="100" 
                                        step="0.01" 
                                        value="{{ isset($storeDetails) && !empty($storeDetails->vendor_share) ? (floor($storeDetails->vendor_share) == $storeDetails->vendor_share ? (int)$storeDetails->vendor_share : $storeDetails->vendor_share) : old('vendor_share', '95') }}"
                                        required
                                    >
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input 
                                        ...
                                        max="100" 
                                        step="0.01" 
                                        value="{{ isset($storeDetails) && !empty($storeDetails->admin_share) ? (floor($storeDetails->admin_share) == $storeDetails->admin_share ? (int)$storeDetails->admin_share : $storeDetails->admin_share) : old('admin_share', '5') }}"
                                        required
                                        readonly
                                    >
...
<script>
    ...
    <script>
function previewImage(event, previewId = 'logo_preview', currentContainerId = 'editlogosrc') {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            ...
            // Hide the current image container if exists
...
$(document).ready(function() {
    ...
    function updateRevenueShares() {
        ...
        // Remove decimal places if adminShare is a whole number
        const formattedAdminShare = adminShare % 1 === 0 ? adminShare.toFixed(0) : adminShare.toFixed(2);

        // Update admin share input
        $('#admin_share').val(formattedAdminShare);
