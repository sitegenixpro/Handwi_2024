                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 col-xs-12">
                                        <div class="form-group d-flex align-items-center">
                                            ...
                                            <input type="file" class="form-control jqv-input" name="image" data-role="file-image" data-parsley-trigger="change" data-preview="image-preview" @if(empty($id)) required
