                                    ...
                                    <div class="product_details-flex d-flex">
                                        ...
                                        <div class="product_content">
                                            ...
                                            <div class="action-divs d-flex align-items-center">
                                                ...
                                                <div class="cancel_btn">
                                                    <button class="cancel-selection" data-role="status-change" href="{{url('admin/order/change_status')}}" detailsid="{{$datavalue->id}}" value="{{config('global.order_status_cancelled')}}">Cancel</button>
