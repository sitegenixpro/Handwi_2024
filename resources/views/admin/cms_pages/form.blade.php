                    ...
                    <form method="post" action="{{route('admin.cms_pages.save')}}" id="admin-form" enctype="multipart/form-data" data-parsley-validate="true">
                        ...
                        <div class="row">
                            ...
                            <div class=" col-md-6 form-group" >
                                ...
                                <input type="text" name="title_ar" id="title_ar" value="{{ $cms_page->title_ar }}" class="form-control jqv-input text-right" placeholder="Enter title in Arabic" >
                            </div>
                            <div class=" col-md-6 form-group">
                            ...
                            <div class=" col-md-12 form-group row mb-4">
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <textarea id="desc_en" name="desc_en" class="form-control  jqv-input description" 
                            ...
                            <div class=" col-md-12 form-group row" >
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <textarea id="desc_ar" name="desc_ar" class="form-control  jqv-input description text-right" >{{ $cms_page->desc_ar  }}</textarea>
                                </div>                            
                            </div>
                        </div>
