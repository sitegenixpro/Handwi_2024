...
<div class="card mb-5">
    <div class="card-header d-flex justify-content-end"><a href="{{url('admin/coupons/create')}}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-plus"></i> Create Promocode</a></div>
    <div class="card-body">
