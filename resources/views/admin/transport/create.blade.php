...
@section('content')
    <div class="card mb-5">
        <div class="card-body">
            <div class="col-xs-12">
                <form method="post" id="admin-form" action="{{ url('admin/save_transport') }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="title" class="form-control" required
									data-parsley-required-message="Enter Title" value="{{ $datamain->title??'' }}">
							</div>
						</div>
                        ...
                        <div class="col-md-6">
							<div class="form-group">
								<label>URL<b class="text-danger">*</b></label>
								<input type="url" name="url" class="form-control" required
									data-parsley-required-message="Enter URL" value="{{ $datamain->url??'' }}">
							</div>
						</div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" name="image" class="form-control" data-role="file-image" data-preview="image-preview" data-parsley-trigger="change"
                                    data-parsley-fileextension="jpg,png,gif,jpeg" data-parsley-required-message="Image required" @if(empty($id)) required @endif
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        App.alert(res['message'], 'Success!');
                                setTimeout(function(){
                                    window.location.href = App.siteUrl('/admin/transport');
                                },1500);
