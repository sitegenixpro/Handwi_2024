   ...
   @endif
        <div class="card-header">
            ...
            <div class="status d-flex justify-content-end ">
                <a href="{{ url('admin/product/featured_create') }}"
                class="btn-custom btn mr-2 mt-2 mb-2" ><i class="fa-solid fa-plus"></i> Add to Featured</a>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown custom-dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                                    ...
                                                    <a class="dropdown-item" href="{{ url('admin/products/editfeatured/' . $item->id) }}"><i
