    ...
    color: #000 !important;
                ...
                <form method="post" id="admin-form" action="{{ url('admin/coupons') }}" enctype="multipart/form-data"
                    ...
                    <div class="col-md-6 form-group chekb-select-multi">
                        ...
                        <select name="distributor[]" class="form-control" multiple id="distributor">
                            @foreach($dist_list as $data)
                            <option value="{{$data->id}}" @if(!empty($datamain->coupon_vender_id)) {{$datamain->coupon_vender_id==$data->id ? "selected" : null}} @endif>{{$data->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" class="form-control basicDate"  name="startdate" value="{{empty($datamain->start_date) ? '': date('Y-m-d', strtotime($datamain->start_date))}}" required
                    ...
                    <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" class="form-control basicDate" name="expirydate" value="{{empty($datamain->coupon_end_date) ? '': date('Y-m-d', strtotime($datamain->coupon_end_date))}}" required
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="minimum_amount" class="form-control" maxlength="5" value="{{empty($datamain->minimum_amount) ? '': $datamain->minimum_amount}}">
                    </div>
