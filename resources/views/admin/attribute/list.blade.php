        ...
        <div class="card-body">
            <form action="{{ url('/admin/attribute_save') }}" method="post" id="admin-form" data-parsley-validate="true"> 
                    ...
                    <div class="row">
                       ...
                       <div class="col-sm-6 col-md-6">
                            <input type="text" name="attribute_name_ar"  id="attribute_name_ar" class="form-control text-right" placeholder="Enter Arabic Name">
                        </div>                   
                    </div><br/>
                    <div class="row">
                            ...
                            <tbody>
                                ...
                                @foreach ($list as $item)   
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ $item->attribute_name_arabic }}</td>
