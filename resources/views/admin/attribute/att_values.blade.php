    ...
    <div class="card-body">
        <form action="{{ url('/admin/attribute_value_save') }}" method="post" id="admin-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 {{ ($datamain['attribute_id']==2)?'':'d-none' }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <input type="text" name="txt_attr_val_name_arabic"  id="txt_attr_val_name_arabic" class="form-control text-right" placeholder="Attribute Value (arabic)" dir="rtl">
                        </div>
                        </div> 
                        <br/>
                        ...
                        <tbody>
                            ...
                            @foreach ($list as $item)   
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">{{ $item->attribute_values_arabic }}</td>
