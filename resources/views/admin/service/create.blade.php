                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group  ">
                         ...
                         <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                                <div class="form-group">
                                    <label>Workshop Name (Arabic)<b class="text-danger">*</b></label>
                                    <input type="text" name="name_ar" class="form-control text-right" required
                                        data-parsley-required-message="Enter Workshop Category Name" value="{{ $name_ar }}">
                                </div>
                         </div>
                         {{-- <div class="col-md-6 form-group">
                          ...
                          {{--<div class="col-md-6 form-group select-category-form-group">
                            <label>Workshop Category<b class="text-danger">*</b></label>
                        ...
                        <!-- <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <label>Workshop Type<b class="text-danger">*</b></label>
                                    <select class="form-control" name="service_price_type">
                                        ...
                                        <option {{($service_price_type=="Per Workshop")?'selected':''}} value="Per Workshop">Per Workshop</option>
                                    </select>
                                </div>
                         </div> -->
                          <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                                <label>Term And Conditions (Arabic)</label>
                                <textarea name="term_and_condition_ar" rows="5" class="form-control text-right">{{ $term_and_condition_ar }}</textarea>
                            </div>
                         </div>
                ...
                <div class="form-group col-md-12">
                    <div id="map_canvas" style="height: 200px;width:100%;"></div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 form-group">
                                                <input type="text" name="item[{{ $j }}][name_ar]" placeholder="Name (AR)"
                                                    value="{{ $item->feature_title_ar ?? '' }}" class="form-control jqv-input text-right" data-jqv-required="true">
                                            </div>
                        ...
                        <select data-url="{{url('admin/sellers_by_categories')}}" class="form-control jqv-input product_catd select2"
                            ...
                            <option value="{{$feature->id}}" <?php echo  $item->event_feature_id ==$feature->id ? 'selected' : ''; ?>>{{$feature->name}}</option>
...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
    <script>
        ...
        $("#activity-idold").change(function(){
        ...
        <div class="row">
            ...
            <div class="col-md-3 form-group">
                <input type="text" name="item[${itemCounter}][name_ar]" placeholder="Name (AR)"
                    class="form-control jqv-input text-right" data-jqv-required="true">
            </div>
            <div class="col-md-5 form-group">
                ${features_html}
            </div>
