...
@section('content') 
    <div class="card mb-5">
        <!-- <div class="card-header">
            <a href="{{ url('admin/maincategory/create') }}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-plus"></i> Create Category</a>
                                ...
                                <td>
                                    <label class="switch s-icons s-outline  s-outline-warning mt-2 mb-2 mr-2">
                                        <input type="checkbox" class="change_status" data-id="{{ $category->id }}"
                                            data-url="{{ url('admin/maincategory/change_status') }}"
                                    ...
                                    <div class="dropdown custom-dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                            <a class="dropdown-item"
                                                href="{{ url('admin/maincategory/edit/' . $category->id) }}"><i
                                            ...
                                            <a class="dropdown-item" data-role="unlink"
                                                ...
                                                href="{{ url('admin/maincategory/delete/' . $category->id) }}"><i
