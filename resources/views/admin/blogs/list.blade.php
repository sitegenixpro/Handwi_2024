...
@section('content')
    <div class="card mb-5">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="mb-0">Total: <b class="primary-color">{{$testimonial->count()}}</b> Blogs</h3>
        @if(GetUserPermissions('testimonials_view'))
            <a href="{{ url('admin/blogs/create') }}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-plus"></i> Create Blog</a>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span>
                                            ...
                                            <img id="image-preview" style="width:100px; height:100px;"
                                                class="img-responsive mb-2 rounded-circle" data-image="{{ $category->blog_image }}"
                                ...
                                <td>
                                    <label class="switch s-icons s-outline  s-outline-warning mt-2 mb-2">
                                        <input type="checkbox" class="change_status" data-id="{{ $category->id }}"
                                            data-url="{{ url('admin/blogs/change_status') }}"
                                    ...
                                    <div class="dropdown custom-dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ url('admin/blogs/edit/' . $category->id) }}"><i
                                                    class="fal fa-edit"></i> Edit</a>
                                            @endif
                                            @if(GetUserPermissions('testimonials_view'))
                                            <a class="dropdown-item" data-role="unlink"
                                                data-message="Do you want to remove this Blog?"
                                                href="{{ url('admin/blogs/delete/' . $category->id) }}"><i
