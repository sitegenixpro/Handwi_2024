...
@section('content')
    <div class="card mb-5">
        <div class="card-body">
            <div class="">
                <form method="post" id="admin-form" action="{{ url('admin/blogs/save') }}" enctype="multipart/form-data"
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name_ar" class="form-control text-right" required
                                    data-parsley-required-message="ادخل العنوان" value="{{ $testimonial->name_ar ?? '' }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea id="description_ar" name="description_ar" class="form-control description text-right"
                                    >{{ $testimonial->description_ar ?? '' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="file" name="image" class="form-control" @if(empty($id)) required @endif data-role="file-image" data-preview="image-preview" data-parsley-trigger="change"
                                    ...
                                    <span class="text-info mt-3 d-block mb-3">Upload image with dimension 1200x650</span>

                                    <img id="image-preview" style="width:90px; height:90px; object-fit: cover;" class="img-fluid rounded-circle mt-2"
                                    src="@if($testimonial!=null){{ $testimonial->blog_image }}@else{{ asset('admin-assets/assets/img/placeholder.jpg')}}@endif">
                          </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        App.alert(res['message'], 'Success!');
                                setTimeout(function(){
                                    window.location.href = App.siteUrl('/admin/blogs');
                                },1500);
