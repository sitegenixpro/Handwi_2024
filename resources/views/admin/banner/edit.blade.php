            ...
            <form method="post" action="{{ url('/admin/banner/update') }}" id="admin-form" enctype="multipart/form-data">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="banner_title_ar" class="form-control jqv-input" 
                            dir="rtl" style="text-align:right;" 
                            value="{{$banner->banner_title_ar}}" data-parsley-required-message="العنوان مطلوب">
                    </div>
                    ...
                    <div class="col-lg-3">
                        <label class="container ml-5">Show on Gift Page
                            <input hidden="" name="is_type_gift" type="checkbox" value="1" @if(!empty($banner)) @if($banner->is_type_gift == 1) checked @endif @endif  data-parsley-multiple="is_type_gift">
