...
@section('content')
    <div class="card mb-5">
        <div class="card-body">
            <div class="">
                <form method="post" id="admin-form" action="{{ url('admin/save_product_feature') }}" enctype="multipart/form-data"
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-12 mb-2">
                            <div class="form-group ">
                                ...
                                <input type="text" name="name_ar" class="form-control text-right" required
                                    data-parsley-required-message="Enter Feature Name in Arabic"
                                    value="{{ $name_ar ?? '' }}">
                            </div>
                        </div>
                         ...
                         <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description_ar" class="form-control text-right">{{ $product_feature?$product_feature->description_ar:'' }}</textarea>
                                </div>
                            </div>
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        App.alert(res['message'], 'Success!');
                            setTimeout(function(){
                                window.location.href = App.siteUrl('/admin/product_features');
                        },1500);
