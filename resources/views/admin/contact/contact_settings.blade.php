                    ...
                    <form method="post" id="admin-form" action="{{route('admin.contact_us_setting_store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">   
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="url" name="pinterest" class="form-control jqv-input" data-jqv-required="true" value="{{$page->pinterest}} " placeholder="Enter Pinterest link " >
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Tiktok </label>
                                <input type="url" name="tiktok" class="form-control jqv-input" data-jqv-required="true" value="{{$page->tiktok}} " placeholder="Enter Tiktok link " >
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Whatsapp Number </label>
                                <input type="text" name="whatsapp" class="form-control jqv-input" data-jqv-required="true" value="{{$page->whatsapp}} " placeholder="Enter Whatsapp Number " >
                            </div>
                            <div class="col-md-6 form-group">
