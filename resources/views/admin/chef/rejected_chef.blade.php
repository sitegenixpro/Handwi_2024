...
@section('footerJs')
    ...
    <script>
       function exportReport(reportType) {
            ...
            let exportUrl = '{{url('admin/chef_approval_export')}}' + '?registration_status=2'

            if(reportType === "pdf") {
                exportUrl = '{{url('admin/chef_approval_pdf')}}' + '?registration_status=2'
            }
            else if( reportType === "csv" ) {
                exportUrl = '{{url('admin/chef_approval_csv_export')}}'+'?registration_status=2'
            }
        ...
        function showApproveModal(id,status) {
            ...
            if(status ==0) {
                ...
                $('.modal-body').html('Are you sure want to move to pending ? ');
            } else {
