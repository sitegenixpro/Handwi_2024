                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12  layout-spacing">
                        ...
                        <div class="">
                            <div class="" style="height: inherit">
                                <form method="post" action="{{ route('admin.save_pending_chef_data') }}" id="admin-form"
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                data-parsley-required-message="Enter Brand Name"
                                                        value="@if(isset($customer) && !empty($customer->brand_name)){{$customer->brand_name}}@elseif(!empty($new_updation) && array_key_exists('brand_name',$new_updation)){{$new_updation['brand_name']}}@endif">
                                                    
                                                </div>

                                                <div class="col-xl-3 col-lg-6 pl-lg-1">
                                                    <label class="control-label">Brand Name AR*</label>
                                                    <input type="text" class="form-control jqv-input text-right" value="@if(isset($customer) && !empty($customer->brand_name_ar)){{$customer->brand_name_ar}} @endif" name="brand_name_ar" id="brand_name_ar" required>
                                                </div>
                                                    ...
                                                    <select class="custom-select  jqv-input" name="dial_code"
                                                            ...
                                                            @foreach ($codes as $country)
                                                                <option value="+{{ $country->country_dial_code }}"
                                                                    {{ $country->country_dial_code == $customer->owner_dial_code ? 'selected' : ($country->country_dial_code == 971 ? 'selected' : '') }}>
                                                ...
                                                data-parsley-required-message="Enter Phone"
                                                        value="{{ $customer->owner_mobile }}"
                                                        class="form-control number jqv-input"
                                                        placeholder="Enter Phone" minlength="8" maxlength="12"
                                                ...
                                                <div class="col-md-6 col-sm-12 form-group">
                                                    ...
                                                    <div class="select2-customdiv">
                                                        <select class="custom-select  select2-cusinine" required name="cousine[]" multiple required data-parsley-required-message="Select Cuisine">
                                                            ...
                                                            @endphp
                                                            @if($customer)
                                                                @php $selectedcuisine = explode(",",$customer->cuisine_ids); @endphp
                                                            @endif
                                                            @foreach($cuisine as $value)
                                                            <option value="{{$value->id}}" @if(in_array($value->id,$selectedcuisine)) selected="selected" @endif>{{$value->cuisine_name}}</option> 
                                                            @endforeach
                                                        </select>
                                                    </div> 
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                data-parsley-required-message="Select License Expiration Date"
                                                        value="@if($customer->license_expiraion != '1970-01-01'){{$customer->license_expiraion}}@endif">
                                                </div>
                                                ...
                                                data-parsley-required-message="Select Maintenance Expiration Date"
                                                        value="@if($customer->maintainance_expiration != '1970-01-01'){{$customer->maintainance_expiration}}@endif">
                                                </div>
                                                ...
                                                data-parsley-required-message="Select Agreement Expiration Date"
                                                        value="@if($customer->agreement_expiration != '1970-01-01'){{$customer->agreement_expiration}}@endif">
                                                </div>
                                                ...
                                                <div class="col-md-3 pr-lg-0">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 pl-lg-0">
                                                            ...
                                                            <input type="text" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" name="preparation_time"
                                                                placeholder="from" data-parsley-min="1" required
                                                data-parsley-required-message="Enter Preperation Time"
                                                                value="{{ $customer->preparation_time }}">
                                                        </div>
                                                        <div class="col-sm-6 pl-lg-0">
                                                            <input type="text"  class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" name="preparation_time_to"
                                                                placeholder="to"
                                                                value="{{ $customer->preparation_time_to }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 pl-lg-0">
                                                    ...
                                                    <br>
                                                    <select name="preparation_unit" class="form-control select-nosearch"
                                                            >
                                                        <option value="mins"
                                                                @if(isset($customer) &&$customer->preparation_unit=='mins') selected @endif>
                                                            Mins
                                                        </option>
                                                        <option value="hour"
                                                                @if(isset($customer) &&$customer->preparation_unit=='hour') selected @endif>
                                                            Hour
                                                        </option>
                                                        <option value="day"
                                                                @if(isset($customer) &&$customer->preparation_unit=='day') selected @endif>
                                                            Day
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                data-parsley-required-message="Enter Order Limit Per Hour"
                                                        value="@if(isset($customer)){{$customer->order_limit_per_hour}}@endif">
                                                                     ...
                                                                     <div class="form-group @if(!empty($new_updation) && array_key_exists('cover_image',$new_updation)){{'cover_preview1'}}@else{{'cover_preview'}}@endif">
                                                                       ...
                                                                       data-caption="" href="">
                                                                        <img id="@if(!empty($new_updation) && array_key_exists('cover_image',$new_updation)){{'image-preview1'}}@else{{'image-preview'}}@endif"
                                                                             ...
                                                                             class="img-responsive mb-2"
                                                                             data-image="@if($customer->cover_image){{ $customer->cover_image }}@else{{asset('public/defaultbanner.png')}}@endif"
                                                                             src="@if($customer->cover_image){{ $customer->cover_image }}@else{{asset('public/defaultbanner.png')}}@endif">
                                                                    </a>
                                                                    </div>
                                                                @else
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-6 form-group">
                                                    ...
                                                    <div class="select2-error">
                                                    <select type="text" name="bank_id" id="bank_id" class="form-control jqv-input select-nosearch" placeholder="Select Bank" data-jqv-required="true" required data-parsley-required-message="Select Bank">
                                                ...
                                                <div class="col-lg-6 form-group">
                                                    ...
                                                    <input data-jqv-required="true" class="form-control  jqv-input" type="text" placeholder="" maxlength="200" id="bank_branch" name="bank_branch" value="{{ $customer->branch }}" required data-parsley-required-message="Select Branch">
                                                           
                                                </div>

                                                <div class="col-lg-6 form-group">
                                                    <label class="control-label">Account Number *</label>
                                                    <input data-jqv-required="true" class="form-control  jqv-input" required data-parsley-required-message="Enter Account Number" type="text" placeholder="" maxlength="20" id="account_no" name="account_no" value="{{ $customer->account_number }}">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input data-jqv-required="true" class="form-control   jqv-input" type="text" placeholder="" minlength="23" maxlength="23" id="ifsc" name="ifsc" value="{{ $customer->iban_number }}" required data-parsley-required-message="Enter IBAN">

                                                        
                                                </div>
                                                <div class="col-lg-6">
                                                    <label class="control-label">Swift(8 - 11 Characters) *</label>
                                                    <input data-jqv-required="true" class="form-control  jqv-input" type="text" placeholder="" title="Use combinations of Number and Letters" minlength="8" maxlength="11" required data-parsley-required-message="Enter Swift" pattern="^[a-zA-Z].*[0-9].*" id="swift" name="swift" value="{{ $customer->swift }}">
                                    ...
                                    <div class="card mt-3" style="border-radius: 5px; overflow: hidden;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            data-parsley-required-message="Select Passport" @endif>
                                                        ...
                                                        {!! viewDocument($customer->passport) !!}
                                                        {!! downloadDocument($customer->passport) !!}
                                                        @endif
                                            ...
                                            data-parsley-required-message="Select Trade License" @endif>
                                                        ...
                                                        @if($customer->id > 0)
                                                        @if($customer->license_doc)
                                                            <!-- {!! previewDocuments($customer->trade_license,50,50,'license_preview') !!} -->
                                                            {!! viewDocument($customer->license_doc) !!}
                                                            {!! downloadDocument($customer->license_doc) !!}
                                                        @endif
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <div class="col-md-6 col-sm-12 form-group">
                                                    ...
                                                    <input type="text" name="apartment_num" class="form-control" id="apartment_num" required data-parsley-required-message="Enter Apartment Number" value="{{$customer->apartment_num}}">
                                                    

                                                </div>
                                                <div class="col-md-6 col-sm-12 form-group">
                                                    <label for="" class="form-label">Building <span class="asteristic">*</span></label>
                                                    <input type="text" name="building" class="form-control" id="building" required data-parsley-required-message="Enter Building" value="{{$customer->building}}">
                                                    
                                                </div>
                                                <div class="col-md-6 col-sm-12 form-group">
                                                    <label for="" class="form-label">Street <span class="asteristic">*</span></label>
                                                    <input type="text" name="street" class="form-control" id="street" value="{{$customer->street}}" required data-parsley-required-message="Enter Street">
                                                    
                                                </div>
                                                <div class="col-md-6 col-sm-12 form-group">
                                                    <label for="" class="form-label">Landmark </label>
                                                    <input type="text" name="landmark" class="form-control" id="landmark"  data-parsley-required-message="Enter Landmark" value="{{$customer->landmark}}">
                                                    
                                                </div>
                                                 <div class="col-md-6 col-sm-12 form-group">
                                                    <label for="" class="form-label">Nick Name</label>
                                                    <input type="text" name="loc_nickname" class="form-control" id="loc_nickname" value="{{$customer->loc_nickname}}">
                                    ...
                                    <div class="mb-2">
                                        <input type="submit" class="mt-4 btn btn-button-7" value="Save">
                                        
                                        <a  class='btn btn-green mt-4' href='javascript:void(0)'  onclick='showApproveModal({{$customer->id}},1)' title='Approve' >Approve</a>
                    ...
                    success: function (res) {
                        ...
                        if (res['status'] == 0) {
                            ...
                            if($('#approve').val() == 1) {
                                ...
                                setTimeout(function () {
                                    window.location.href="{{url('admin/chef_pending_approval')}}";
                                }, 1500);
                            }
