        ...
        <div class="page-header page-header_custom">
            ...
            <div class="page_header_btns">
                ...
                <a href="{{ route('admin.chef.create') }}" class="mt-4 btn-custom" style="float: right;"> <i class='bx bx-plus mr-1' ></i> Add
                    New</a>
                    <a href="{{ route('admin.chef.sorting') }}" class="mt-4 btn-custom" style="float: right;"> <i class='bx bx-plus mr-1' ></i> Sort</a>
            </div>
        </div>
...
@section('script')
    <script>
        ...
        function exportReport(reportType) {
            ...
            let exportUrl = '{{url('admin/chef/export')}}' + '?'

            if(reportType === "pdf") {
                exportUrl = '{{url('admin/chef_pdf_export')}}' + '?'
            }
            else if( reportType === "csv" ) {
                exportUrl = '{{url('admin/chef_csv_export')}}' + '?'
            }
            if ($('#name').val() != '') {
