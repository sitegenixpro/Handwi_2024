...
@section('content')
    <div class="card mb-5">
        <div class="card-header">
            <a href="{{ url('admin/product_master/create') }}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-plus"></i> Create Product</a>
            <a href="{{ url('admin/import_product_master') }}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-download"></i> Import</a>
        </div>
        <div class="card-body">
                                ...
                                <td>
                                    <label class="switch s-icons s-outline  s-outline-warning mt-2 mb-2 mr-2">
                                        <input type="checkbox" class="change_status" data-id="{{ $category->id }}"
                                            data-url="{{ url('admin/product_master/change_status') }}"
                                    ...
                                    <div class="dropdown custom-dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                            <a class="dropdown-item"
                                                href="{{ url('admin/product_master/edit/' . $category->id) }}"><i
                                                    class="flaticon-pencil-1"></i> Edit</a>
                                            <a class="dropdown-item" data-role="unlink"
                                                data-message="Do you want to remove this Product Master?"
                                                href="{{ url('admin/product_master/delete/' . $category->id) }}"><i
