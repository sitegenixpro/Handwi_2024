...
@section('content')
 ...
 <div class="col-md-6">
     ...
     <div class="row">
       <div class="col-md-8">
         <h4 class="mb-4">Import Master Products</h4>
       </div>
       <div class="col-md-4 text-right">
         <a href="{{url('admin/download_masterproduct_format')}}" class="btn btn-dark btn-sm"><i class="fa fa-download" aria-hidden="true"></i>&nbsp; Blank Excel</a>
       </div>
     </div>
     ...
     <form action="#" method="post" class="form pt-5">
       <div id="xls-upload" data-upload-options='{"action":"<?=url('admin/master_pd_upload_file')?>"}'>
       </div>
   </form>
 ...
 <!-- Upload image zip file -->
     ...
     <form action="#" method="post" class="form pt-5" style="display:none;">
 ...
 <div class="col-md-6">
   ...
   <h4 class="mb-4" style="display:none;">Export Products</h4>
   <form id="exportForm" method="get" action="{{route('admin.product.export')}}" style="display:none;">
...
(function($) {
	...
	$(function() {
        ...
        function startTask() {
            var $def = $.Deferred();
            es = new EventSource('<?php echo url("admin/start_master_import") ?>');
