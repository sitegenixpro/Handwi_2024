...
@section('content')
    <div class="card mb-5">
        <div class="card-header">
            <!-- <a href="{{ url('admin/product_request/create') }}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-plus"></i> Request Product</a> -->
...
<td>
                                    <label class="switch s-icons s-outline  s-outline-warning mt-2 mb-2 mr-2">
                                        <input type="checkbox" class="change_status" data-id="{{ $category->id }}"
                                            data-url="{{ url('admin/product_request/change_status') }}"
                                    ...
                                    <div class="dropdown custom-dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                            <a class="dropdown-item"
                                                href="{{ url('admin/product_request/edit/' . $category->id) }}"><i
                                                    class="flaticon-pencil-1"></i> Edit</a>
                                           <!--  <a class="dropdown-item" data-role="unlink"
                                                data-message="Do you want to remove this Product Master request?"
                                                href="{{ url('admin/product_request/delete_re/' . $category->id) }}"><i
