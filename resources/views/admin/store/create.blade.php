    ...
    data-parsley-maxlength="12" data-parsley-trigger="keyup" data-parsley-errors-container="#mob_err"  @if($id) value="{{$store->mobile}}" @endif>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" name="cover_image" class="form-control" data-role="file-image" data-preview="image-preview-b" data-parsley-trigger="change"
                                data-parsley-fileextension="jpg,png,gif,jpeg"
                                data-parsley-fileextension-message="Only files with type jpg,png,gif,jpeg are supported" data-parsley-max-file-size="5120" data-parsley-max-file-size-message="Max file size should be 5MB"  {{$c_req}} data-parsley-required-message="Select Cover Image">
