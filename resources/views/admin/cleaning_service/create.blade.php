...
@section('content')
    <div class="card mb-5">
        <div class="card-body">
            <div class="col-xs-12">
                <form method="post" id="admin-form" action="{{ url('admin/save/cleaning_service') }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Cleaning Service Type<b class="text-danger">*</b></label>
                                <input type="text" name="title" class="form-control" required
                                       data-parsley-required-message="Enter brand Name" value="{{$title}}">
                            </div>
                        </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        setTimeout(function(){
                            window.location.href = App.siteUrl('/cleaning-services');
                        },1500);
