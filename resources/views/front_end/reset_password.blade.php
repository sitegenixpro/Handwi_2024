...
<head>
    ...
    <title>{{ config('app.name') }} | Portal Reset Passowrd </title>
...
<body class="login login-box h-100 d-flex align-items-center justify-content-center"
    >
                ...
                <form method="POST" class="form-login" action="" data-parsley-validate="true" data-parsley-validate="true">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center mb-4">
                            <img alt="logo" src="{{ asset('') }}admin-assets/assets/img/handwi-logo-black.svg"
