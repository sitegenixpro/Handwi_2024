...
<style>
    ...
    .shop-top-filter .collection-hero__image { 
        background-image: url('{{ asset($gift->banner_image) }}'); 
    }
...
<div id="page-content">
                ...
                <div class="collection-header">
                    <div class="collection-hero medium mb-4 mb-lg-5">
                        ...
                        <div class="collection-hero__title-wrapper container">
                            <h1 class="collection-hero__title medium">{{$gift->name}}</h1>
                            <div class="breadcrumbs text-uppercase mt-1 mt-lg-2"><a href="{{ route('home') }}" title="Back to the home page">Home</a><span>|</span><span class="fw-bold">{{$gift->name}}</span></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <!--Category Grid-->
                    <div class="collection-slider-4items grid-categorys sub-collection grid-mr-15">
