                ...
                <table width="100%">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td>Invoice: 
                                <span class="w-100 d-block font-weight-bold mt-2"><a href="{{ url('portal/order_invoice/' . $list[0]->order_id.'/'.$order_product->id) }}" target="_blank"><button type="button" class="btn btn-primary">View Invoice</button></a></span></td>
            ...
            <?php } ?>
                ...
                <div class="order-page-infomatics">
                     ...
                     <div class="row">
                                   ...
                                   @if($order_product->reject_reason)
                                          <span> Status: {{$order_product->reject_reason}} </span>
                                          @endif
