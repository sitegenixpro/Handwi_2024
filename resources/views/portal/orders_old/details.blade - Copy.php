                                            ...
                                            <div class="action-divs d-flex align-items-center">
                                                ...
                                                <div class="cancel_btn">
                                                    <button type="button" class="btn btn-danger">Cancel</button>
                                                     @if($datavalue->order_status != config('global.order_status_cancelled') || $datavalue->order_status != config('global.order_status_delivered'))
                                                    @if($datavalue->order_status == config('global.order_status_pending'))
                                                    <span class="btn btn-warning" data-role="status-change" href="{{url('vendor/order/change_status')}}" detailsid="{{$datavalue->id}}" value="{{config('global.order_status_accepted')}}" >Accept</span>
                                                    @endif

                                                    @if($datavalue->order_status == config('global.order_status_accepted'))
                                                    <span class="btn btn-design" data-role="status-change" href="{{url('vendor/order/change_status')}}" detailsid="{{$datavalue->id}}" value="{{config('global.order_status_ready_for_delivery')}}" >Ready for Delivery</span>
                                                    @endif

                                                    @if($datavalue->order_status == config('global.order_status_ready_for_delivery'))
                                                    <span class="btn btn-info" data-role="status-change" href="{{url('vendor/order/change_status')}}" detailsid="{{$datavalue->id}}" value="{{config('global.order_status_dispatched')}}" >Dispatched</span>
                                                    @endif

                                                    @if($datavalue->order_status == config('global.order_status_dispatched'))
                                                    <span class="btn btn-success" data-role="status-change" href="{{url('vendor/order/change_status')}}" detailsid="{{$datavalue->id}}" value="{{config('global.order_status_delivered')}}" >Delivered</span>
                                                    @endif
                                                     @endif
                                                </div>
                                                @endif
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                                    ...
                                    <div class="delivery-status-block">
                                        <ul class="list-unstyled">
                                            ...
                                            @else
                                            <li class="delivered"><button class="btn-design">Cancelled</button></li>
                                            @endif
