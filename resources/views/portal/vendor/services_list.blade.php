...
@section("header")
    ...
    <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
     ...
     <link href="http://localhost/healthy_wealthy/public/admin-assets/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        ...
        <link href="http://localhost/healthy_wealthy/public/admin-assets/assets/css/sidebar.css" rel="stylesheet" type="text/css" />
                        ...
                        <td class="text-center">
                            <div class="dropdown custom-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                    ...
                                    href="{{ url('portal/vendor/delete_services?vendor_id='.$datarow->vendor_id.'&service_id=' . $datarow->vendor_service_id) }}"><i
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form name="add_vendor_services" id="add_vendor_services" method="post" action="{{ url('portal/vendor/add_services') }}">
                <div class="modal-body position-relative">

                  
                    <select id="ven_services" class="w-100" name="ven_services" multiple="multiple">
...
<script src="http://localhost/healthy_wealthy/public/admin-assets/bootstrap/js/bootstrap-multiselect.js"></script>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res['status'] == 0) {
                    ...
                    App.alert(res['message']);
                    setTimeout(function() {
                        window.location.href = App.siteUrl('/portal/vendor/view_services');
                    }, 1500);
                }
