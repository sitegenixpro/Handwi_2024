      ...
      <div class="row">
        <form method="get" action='' class="col-sm-12 col-md-12">
            <div id="column-filter_filter" class="dataTables_filter">
                <div class="row">
                    <div class="col-lg-3">
                        <label class="w-100">Customer Type:
                            <select name="customer_type" class="form-control form-control-sm" id="customer_type">
                                <option value="" disabled {{ empty($customer_type) ? 'selected' : '' }}>Select Customer Type</option>
                                <option value="bookings" {{ $customer_type == 'bookings' ? 'selected' : '' }}>Bookings</option>
                                <option value="orders" {{ $customer_type == 'orders' ? 'selected' : '' }}>Orders</option>
                            </select>
                        </label>
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <div class=" mt-3">
                            ...
                            <a href="{{url('portal/report/customers')}}"  class="btn btn-primary">Clear</a>
        ...
        <span>Total {{ $list->total() }} entries</span>
            ...
            <div class="col-sm-12 col-md-12 pull-right">
                ...
                {!! $list->appends(request()->input())->links('portal.template.pagination') !!}
                </div>
            </div>
        </div>
    </div>
