...
@section('content')
 ...
 <div class="col-md-6">
     ...
     <div class="row">
       ...
       <div class="col-md-4 text-right">
         <a href="{{url('portal/product/download_format')}}" class="btn btn-dark btn-sm"><i class="fa fa-download" aria-hidden="true"></i>&nbsp; Blank Excel</a>
       </div>
     </div>
     ...
     <form action="#" method="post" class="form pt-5">
       <div id="xls-upload" data-upload-options='{"action":"<?=url('portal/Excel/upload_file')?>"}'>
       </div>
   </form>
 ...
 <!-- Upload image zip file -->
     ...
     <form action="#" method="post" class="form pt-5">
       <div id="zip-upload" data-upload-options='{"action":"<?=url('portal/Excel/upload_zip_file')?>"}'></div>
   </form>
   <div class="text-center pt-5">
     <a id="start-unzip" href="<?=url('portal/Excel/startUnzipImage')?>" class="btn btn-primary" style="display: none;"><i class="fa fa-play" aria-hidden="true"></i>&nbsp; Unzip</a>
   </div>
 ...
 <div class="col-md-6">
   ...
   <form id="exportForm" method="get" action="{{route('portal.product.export')}}">
     <div class="form-group">
       ...
       <div class="form-group">
         <label>Category</label>
          <select id="category-select" data-url="{{url('portal/sellers_by_categories')}}" class="form-control jqv-input product_catd select2" data-jqv-required="true"
...
(function($) {
	...
	$(function() {
        ...
        function startTask() {
            var $def = $.Deferred();
            es = new EventSource('<?php echo url("portal/start_import") ?>');
