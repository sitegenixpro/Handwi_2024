                    ...
                    <div class="card-body">
                       ...
                       <div class="col-md-6 form-group ">
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" name="shipment_and_policies" class="form-control jqv-input" data-jqv-required="true"
                                value="{{ $shipment_and_policies }}">
                        </div>
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="row  d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-12 form-group item-details-wrap">
