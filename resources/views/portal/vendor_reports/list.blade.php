                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="d-flex align-items-center">
                                <span class="ml-3">
                                   {{ucfirst($list->user->first_name)}} {{ ucfirst($list->user->last_name) }}
                                    @if($list->user->user_name)<div><a class="yellow-color" href="{{ route('admin.customers.edit', ['id' =>$list->user->id]) }}">{{ '@'. $list->user->user_name }}</a></div>@endif
                                    <div><a class="yellow-color" href="mailto:{{$list->user->email}}">{{$list->user->email}}</a></div>
                                    <div><a class="yellow-color" href="https://wa.me/+{{$list->user->dial_code}}{{$list->user->phone}}" target="_blank">+{{$list->user->dial_code}} {{$list->user->phone}}</a></div>
                                </span>
                        ...
                        <td>{{$list->reason->reason}}{{$list->other_reason?' - '.$list->other_reason:''}}</td>
