...
class ProductRequestController extends Controller
{
    ...
    public function index()
    {
        ...
        $categories = ProductMasterRequest::where(['deleted'=> 0])->orderBy('id', 'DESC')->get();
        
        return view('admin.product_request.list', compact('page_heading', 'categories'));
    }
    ...
    public function create()
    {
        ...
        return view("admin.product_request.create", compact('page_heading', 'category', 'mode', 'id', 'name', 'parent_id', 'image', 'active', 'categories', 'banner_image','description','product_type','specs'));
    }
    ...
    public function edit($id)
    {
        ...
        if ($datamain) {
            ...
            return view("admin.product_request.create", compact('page_heading', 'category', 'mode', 'id', 'name', 'parent_id', 'image', 'active', 'categories', 'banner_image','product_type','description','specs'));
        } else {
            abort(404);
        }
    }
