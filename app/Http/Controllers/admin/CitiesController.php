...
class CitiesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view("admin.cities.create", compact('page_heading', 'countries', 'mode','name_ar', 'id', 'name', 'active', 'country_id', 'state_id','states'));
    }
    ...
    public function edit($id)
    {
        ...
        if ($cities) {
            ...
            return view("admin.cities.create", compact('page_heading', 'mode', 'id', 'name','name_ar', 'active', 'country_id', 'countries', 'states', 'state_id'));
        } else {
            abort(404);
        }
    }
