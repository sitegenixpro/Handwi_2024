! function (i, t, e) {
    ...
    function n() {
        var e, n = i(".site-header").not(".header_trans-fixed").outerHeight(),
            a = i(".menu-wrapper").data("top"),
            s = i("#wpadminbar").outerHeight();
        i("#wpadminbar").length ? (e = s + n, i(".site-header").css("margin-top", s)) : e = n, i(t).width() < a ? i(".menu-wrapper").css("padding-top", e + "px") : i("#wpadminbar").length && i(".site-header").hasClass("header_trans-fixed") ? i(".menu-wrapper").css("padding-top", s + "px") : i(".menu-wrapper").css("padding-top", "0"), i("#wpadminbar").length && i(t).width() < 768 && i("#wpadminbar").css({
            position: "fixed",
            top: "0"
        })
    }
    ...
    //     i(n).length && i("html,body").animate({
    //         scrollTop: i(n).offset().top - i(".header_trans-fixed").outerHeight() - i("#wpadminbar").outerHeight()
    //     }, "slow")
    // }), 
    i(".open-search").on("click", function () {
        ...
        i(this).parent().toggleClass("is-active"), i(this).parent().hasClass("is-active") && setTimeout(function () {
    ...
    }), i(t).on("scroll", function () {}), i(t).on("load resize", function () {
        n(), a(), s()
